...
export type NotificationsRecord = {
	...
	created?: IsoDateString
	flyer?: RecordIdString
	id: string
	last_seen?: IsoDateString
	tags?: string
	text?: string
	time_to_send: IsoDateString
	updated?: IsoDateString
	user?: RecordIdString
}
...
export type FlyersResponse<Tcontents = unknown, Texpand = unknown> = Required<FlyersRecord<Tcontents>> & BaseSystemFields<Texpand>
